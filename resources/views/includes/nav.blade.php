<nav class="navbar navbar-default">
  <div class="container">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="{{ route('index') }}">Learn</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right">
        @unless (Auth::check())
          <li><a href="{{ action('Auth\AuthController@getLogin') }}">Войти</a></li>
        ...
        @else
          <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              ...
              <li><a href="{{ action('UsersController@edit') }}">Загрузить Аватар</a></li>
              <li class="divider"></li>
